...
namespace SHHS.View
{
    public class SHHSCountDown : SHHSTimer
    {
        ...
        void CanvasView_PaintSurface(object sender, SKPaintSurfaceEventArgs e)
        {
            ...
            SKRect titileBound = GetTextBound(infoPaint, info.Rect, EventTitle, 0.6F);
            canvas.DrawText(EventTitle, (info.Rect.Right + info.Rect.Left) / 2F - titileBound.MidX,  titileBound.Height, infoPaint);
